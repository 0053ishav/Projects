...
import { Loader2, RefreshCw, Code, Database, Sparkles } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Switch } from "@/components/ui/switch"
import { Label } from "@/components/ui/label"
import { motion } from "framer-motion"
import { fadeIn, fadeInUp, heroButtonVariants, heroTextVariants, staggerContainer } from "@/hooks/use-animations"
...
export default function Home() {
  ...
  const apiUrl = useExternalApi ? "https://projects.ishav.space/api/projects" : "/api/projects"
  ...
  const allTags = projects ? Array.from(new Set(projects.flatMap((project) => project.tags))).sort() : []

  // Filter projects based on active filter
  const filteredProjects = activeFilter ? projects?.filter((project) => project.tags.includes(activeFilter)) : projects
      ...
      <section className="relative bg-gradient-to-b from-primary/10 to-background py-16 md:py-24 overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Full-Stack Developer exploring the Digital Cosmos | Navigating the tech universe with Next.js
            </motion.p>
            <motion.div
              initial="hidden"
              animate="visible"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground">Explore my latest work and personal projects</p>
            </div>
            ...
            <motion.div
              ...
              className="flex items-center mt-4 md:mt-0 space-x-2 bg-muted/50 p-2 rounded-lg"
            >
          ...
          {isLoading ? (
            ...
            <>
              {allTags.length > 0 && (
                <FilterBar tags={allTags} activeFilter={activeFilter} onFilterChange={handleFilterChange} />
              )}
              ...
              {filteredProjects?.length === 0 && (
                ...
                >
                  ...
                  <Button variant="outline" onClick={() => handleFilterChange(activeFilter!)}>
                    Clear Filter
                  </Button>
                </motion.div>
              )}
